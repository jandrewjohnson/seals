---
title: "Worked example: Kenya DEMETRA-SEALS-InVEST"
...
module it used have since been retired to `seals/seals/old_run_files/` and are
...
For a current walkthrough see [SEALS Quickstart](quickstart.qmd) and
[First SEALS run walkthrough](walkthrough.qmd).
:::
...
The steps below are the SEALS install applied to this example. For the canonical
version, see [Installation](environment_setup.md); for the devstack-wide options,
see the [devstack installation guide](https://justinandrewjohnson.com/earth_economy_devstack/installation.html).
...
1.  Locate `run_seals_standard.py` in `seals/seals/`
