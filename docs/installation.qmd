...
hazelbean 2.0.0 or later. Do not pin a Python version — let conda pick one. On
conda-forge, hazelbean 2.0.0 is built for Python 3.11, 3.12 and 3.13, and asking
for an older Python makes the solver quietly fall back to hazelbean 1.x, which
SEALS cannot run.
