"""LUH2 300m global SEALS run with post-processing: standard-with-postprocessing task tree driven by luh2_300m_global_postprocessing.csv."""
import os
...
def run_project(scenario_definitions_filename='luh2_300m_global_postprocessing.csv',
                project_name='luh2_300m_global',
                extra_dirs=None,
                run_mode='check',
                tasks_to_skip=None):
    """Build and execute the LUH2 300m global SEALS pipeline (with post-processing tasks)
    against a given scenarios CSV.
