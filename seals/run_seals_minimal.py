"""Minimal SEALS run: standard task tree on standard_scenarios.csv; the __main__ run takes a fresh timestamped project dir each time."""
import os
...
def run_project(scenario_definitions_filename='standard_scenarios.csv',
                ...
                tasks_to_skip=None,
                execute=True):
    """Build and execute the minimal SEALS pipeline against a given scenarios CSV.
